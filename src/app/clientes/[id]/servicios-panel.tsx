  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-surface border border-border rounded-[10px] shadow-card overflow-hidden">
        ...
        {servicios.length === 0 ? (
          <div className="px-5 py-10 text-center text-text-tertiary text-sm">Sin servicios contratados</div>
        ) : (
      ...
      <div className="bg-surface border border-border rounded-[10px] shadow-card overflow-hidden">
        ...
        {tareas.length === 0 ? (
          <div className="px-5 py-10 text-center text-text-tertiary text-sm">Sin tareas registradas este mes</div>
        ) : (
          <div className="divide-y divide-border/50">
            {tareas.map((t) => (
      ...
      <div className="bg-surface border border-border rounded-[10px] shadow-card overflow-hidden">
        ...
        {pagos.length === 0 ? (
          <div className="px-5 py-10 text-center text-text-tertiary text-sm">Sin pagos registrados</div>
        ) : (
          <div className="divide-y divide-border/50">
            {pagos.map((p) => (
      ...
      <div className="bg-surface border border-border rounded-[10px] shadow-card overflow-hidden">
        ...
        {terceros.length === 0 ? (
          <div className="px-5 py-10 text-center text-text-tertiary text-sm">Sin servicios de terceros</div>
        ) : (
          <div className="divide-y divide-border/50">
            {terceros.map((t) => (
              <div key={t.id} className="px-5 py-3 flex items-center gap-3">
